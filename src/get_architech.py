...
from constant import ARCFACE_MS1MV3, COSFACE_GLINT360K, RESNET_VGGFACE, RESNET_WEBFACE
...
def get_model(model_name):
    if model_name == "restnet_vggface":     
        ...
        cp_pack = RESNET_VGGFACE
        
    elif model_name == "restnet_webface":
        model =  InceptionResnetV1("casia-webface")
        cp_pack = RESNET_WEBFACE
    elif model_name == "arcface_ms1mv3":
        model = iresnet100()
        cp_pack = ARCFACE_MS1MV3
    elif model_name == "cosface_glint360k":
        model = iresnet100()
        cp_pack = COSFACE_GLINT360K
    else:
        raise ValueError(
