...
python script/evaluate_result.py \
    --result_dir output/seed=22520691_log_NSGAII_niter=1000_label=1_reconsw=0.5_attackw=0.5_saliencyw=0.0_guided=0_popsize=100_toursize=4_patchsize=16_problocationmutate=0.2_probpatchmutate=0.9_fitnesstype=normal \
    --algorithm NSGAII 

python script/evaluate_result.py \
    --result_dir output/seed=22520691_log_NSGAII_niter=1000_label=0_reconsw=0.5_attackw=0.5_saliencyw=0.0_guided=0_popsize=100_toursize=4_patchsize=16_problocationmutate=0.2_probpatchmutate=0.9_fitnesstype=normal \
    --algorithm NSGAII 
